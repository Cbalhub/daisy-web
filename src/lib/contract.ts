...
export function buildContractSections(d: {
  ...
  const sections: ContractSection[] = [
    ...
    },
    {
      title: "제13조 (통지)",
      body: [
        "이 계약과 관련한 당사자 간의 통지·연락은 계약서에 기재된 이메일 주소로 하며, 정상적으로 발송된 이메일은 반송되지 않는 한 발송일로부터 24시간이 지난 때에 상대방에게 도달한 것으로 본다.",
        "당사자는 자신의 이메일·연락처가 변경된 경우 지체 없이 상대방에게 알려야 하며, 이를 게을리하여 통지가 도달하지 못한 불이익은 통지하지 않은 당사자가 부담한다.",
      ],
    },
    {
      title: "제14조 (분쟁의 해결)",
      body: [
        "이 계약과 관련한 분쟁은 양 당사자가 우선 협의하여 해결하며, 협의가 이루어지지 않을 경우 을의 주소지를 관할하는 법원(을의 주소가 이 계약서에 특정되지 않은 경우 서울중앙지방법원)을 제1심 관할 법원으로 하고, 대한민국 법령을 준거법으로 한다.",
      ],
    },
    {
      title: "제15조 (기타)",
